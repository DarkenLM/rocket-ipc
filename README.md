...
```bash
$ git clone https://github.com/darkenlm/rocket-ipc.git <your project directory>
...
1. Replace my name with yours: `Rafael Fernandes`
2. Replace my website URL with yours: `https://darkenlm.github.io/`
3. Replace my *GitHub* username and project name with yours: `darkenlm/rocket-ipc`
4. Replace my *NPM* project name with yours: `rocket-ipc`
...
[project-url]: https://github.com/darkenlm/rocket-ipc
[package-image]: https://badge.fury.io/js/rocket-ipc.svg
[package-url]: https://badge.fury.io/js/rocket-ipc
[issues-image]: https://img.shields.io/github/issues/darkenlm/rocket-ipc.svg?style=popout
[issues-url]: https://github.com/darkenlm/rocket-ipc/issues
[build-image]: https://travis-ci.org/darkenlm/rocket-ipc.svg?branch=master
[build-url]: https://travis-ci.org/darkenlm/rocket-ipc
[coverage-image]: https://coveralls.io/repos/github/darkenlm/rocket-ipc/badge.svg?branch=master
[coverage-url]: https://coveralls.io/github/darkenlm/rocket-ipc?branch=master
[dependencies-image]: https://david-dm.org/darkenlm/rocket-ipc/status.svg
[dependencies-url]: https://david-dm.org/darkenlm/rocket-ipc
[dev-dependencies-image]: https://david-dm.org/darkenlm/rocket-ipc/dev-status.svg
[dev-dependencies-url]: https://david-dm.org/darkenlm/rocket-ipc?type=dev
